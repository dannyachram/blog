...
@section('container')
<h1 class="mb-3 text-center fs-3">{{ $title }}</h1>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="position-absolute px-3 py-2 text-white" style="background-color: rgba(0, 0, 0, 0.7)"><a href="/posts?category={{ $post->category->slug }}" class="text-decoration-none text-light">{{ $post->category->name}}</a></div>
...
@else
  <div class="card justify-content-center mb-5 img-fluid">
    ...
    <div class="card-body text-center">
      <p class="card-text fw-bold fs-1">POST WAS NOT FOUND !</p>
